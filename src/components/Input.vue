          ...
          <footer className="mt-auto">
            <div className="mx-auto w-full max-w-screen-xl p-2">
              <span className="text-center block text-sm text-muted-foreground">
                <a target="_blank" href="https://github.com/sinnedpenguin/dennx" className="hover:underline">
                  DennX
                </a>
                - AI-powered chatbot -
                <a target="_blank" href="https://sinnedpenguin.me/" className="hover:underline">
                  sinnedpenguin
                </a>
              </span>
            </div>
