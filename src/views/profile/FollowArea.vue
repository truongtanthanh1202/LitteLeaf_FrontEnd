<template>
  <div id="follow-area">
    <span
      ...
      data-bs-target="#follow-modal"
      @click="getFollowing"
      style="cursor: pointer"
      ><i>Following:</i> <strong>{{ userInfo['following'] }}</strong></span
    >
    <span
      v-if="!profileOwner && !followStatus"
      @click="followUser"
      title="Follow"
    ...
    <span
      ...
      @click="getFollowers"
      style="cursor: pointer"
      ><i>Follower:</i> <strong>{{ userInfo['follower'] }}</strong></span
    >
